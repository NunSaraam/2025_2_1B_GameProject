...
public class CityGenerator : EditorWindow
{
    ...
    private int gridSizeZ = 10;                     //도시 새로 크기
    private float buildingSpacing;                  //건물 사이 간격
    ...
    private void OnGUI()                                        //에디터 창 UI 그리기
    {
        ...
        gridSizeZ = EditorGUILayout.IntField("Grid Size Z", gridSizeZ);         //X크기 입력
        ...
        if (GUILayout.Button("Clear Ciity"))                    //도시 삭제 버튼
        {
            ClearCity();
        }
    ...
    private void CreateBuilding(Vector3 position, Transform parent)
    {
        ...
        float height = Random.Range(5.0f, 20.0f);               //랜덤 높이 건물
    ...
    private void CreateRoad(Vector3 position, Transform parent)
    {
        ...
        renderer.material.color = new Color(0.3f, .3f, .3f);                            //회색 색상
    ...
    private void GenerateCity()
    {
        ...
        GameObject roadsParent = new GameObject("Raods");
